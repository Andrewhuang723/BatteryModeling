...
if [ "$1" = "DOE" ]; then
    $PYTHON_PATH run_DOE.py --DATA_PATH ./example/EXP_DATA/SV_0015_N20_1C.csv --SAVE_DIR ./example/DOE_sigma_n --CPU_CORE_IDX 2 --config ./config/doe_config.yaml --parameters_config ./config/parameters_config.yaml 
elif [ "$1" = "OPT" ]; then
